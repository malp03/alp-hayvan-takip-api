...
class IslemGecmisi(Base):
    ...
    islem_tipi = Column(String, index=True, nullable=True)
    kullanici_id = Column(String, nullable=True)
    kullanici_adi = Column(String, nullable=True)
    rol = Column(String, nullable=True)
    ciftlik_id = Column(String, index=True, nullable=True)
    hedef_tipi = Column(String, nullable=True)
